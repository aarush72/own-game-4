...
function setup() {
  ...
  box35 = new Box(800,400,40,40);
  box36 = new Box(850,400,50,50);
 ...
 //hanger slings
  ...
  hsling1 = new HSling(box35.body,{x : 800, y : 200})
  hsling2 = new HSling(box36.body,{x : 850, y : 200})
...
function draw() {
  ...
  textSize(20)
  fill("red")
  text("Level 5 coming soon",580,100)
